...
use slice_ring_buffer::SliceRingDeque;
...
// [SliceRingDeque] doesn't implement [Send] (since it uses raw pointers
...
impl<R> Decoder<R> {
    ...
    pub fn new(reader: R) -> Self {
        ...
        Self {
            reader,
            buffer: SliceRingDeque::with_capacity(BUFFER_SIZE),
